...
int main()
{
    ...
    for(int i=0;i<n;i++)
        for(int j=0;j<n;j++)
            tab2[i][j] = j;
    char sciezka2[] = "pliki_tekstowe/liczby.txt";
    char sciezka[] = "pliki_tekstowe/tekst.txt";
	char sciezka3[] = "pliki_tekstowe/tekst2.txt";
	char sciezka4[] = "pliki_tekstowe/tekst3.txt";
	char sciezka5[] = "pliki_tekstowe/tekst4.txt";
	char sciezka6[] = "pliki_tekstowe/tekst5.txt";
    char sciezka7[] = "pliki_tekstowe/tekst6.txt";
